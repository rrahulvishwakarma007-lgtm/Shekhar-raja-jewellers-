    ...
    <div style={{ background: C.bg }} className="pt-20 min-h-screen">
      <section style={{ paddingBottom: 0 }}>
        ...
        <div className="w-full overflow-hidden pb-8 pt-4">
          <div className="w-[90%] mx-auto rounded-3xl aspect-[16/9] animate-pulse" style={{ background: 'rgba(248,187,217,0.3)' }} />
        </div>
      </section>
    </div>
  );
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6 }} style={{ background: C.bg }} className="pt-20">
      ...
      <section style={{ background: C.bg, paddingBottom: 0 }}>
        ...
        {/* ── TANISHQ-STYLE CENTER MODE CAROUSEL WITH OBJECT-CONTAIN & RICH LUXURY FRAME ── */}
        <div className="w-full relative overflow-hidden py-4 sm:py-6" style={{ background: C.bg }}>
          {/* Main slider track using a fluid 16:9 / 21:9 responsive aspect ratio container */}
          <div className="relative aspect-[16/9] sm:aspect-[21/9] max-w-7xl mx-auto w-[92%] sm:w-[88%] lg:w-[85%] flex items-center justify-center">
            {promoBanners.map((banner, i) => {
              ...
              return (
                <motion.div
                  key={i}
                  className="absolute inset-0 rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl cursor-grab active:cursor-grabbing bg-gradient-to-br from-[#2C1A1D] via-[#1A0010] to-[#3D001C] flex items-center justify-center p-2 sm:p-4 border"
                ...
                >
                  <img src={banner.img} alt={banner.label} className="w-full h-full object-contain object-center pointer-events-none drop-shadow-xl" />
                </motion.div>
              );
            })}
          </div>
        ...
        <div className="w-full overflow-hidden py-3 border-y border-opacity-30 relative flex items-center" style={{ background: C.gold, borderColor: C.goldLt }}>
          <motion.div 
            className="flex whitespace-nowrap"
            animate={{ x: ["0%", "-50%"] }}
            transition={{ ease: "linear", duration: 35, repeat: Infinity }}
          >
            {/* The string is repeated to ensure continuous looping without gaps */}
            <span className="font-raleway text-sm font-semibold text-white tracking-widest px-4">
              स्वर्ण समृद्धि योजना : 10 किस्तें आपकी - 2 किस्तें हमारी • अपने सपनों के सोने के आभूषण अब आसान किस्तों में खरीदें ! • योजना की विशेषताएँ : ग्राहक केवल 10 मासिक किस्तें जमा करेगा। • अंतिम 2 किस्तों का भुगतान शेखर राजा ज्वेलर्स द्वारा किया जाएगा। • कुल 12 किस्तों के मूल्य का सोने का आभूषण खरीदने का अवसर • 100% पारदर्शी एवं विश्वसनीय योजना • आज ही जुड़ें और अपने सपनों के गहनों की शुरुआत करें! • शेखर राजा ज्वेलर्स - विश्वास शुद्धता गुणवत्ता • ज्वेलरी बुकिंग एवं अधिक जानकारी के लिए आज ही हमारे शोरूम पर संपर्क करें: +91 98765 43210 • www.shekharrjewellers.com • सोना सिर्फ आभूषण नहीं, आपके सपनों का निवेश है • जीरो मेकिंग चार्ज योजना : 10 किस्तें आपकी - ज़ीरो मेकिंग चार्ज हमारी • अपनाएं आज, बचत करें कल, पाएं ज़ीरो मेकिंग चार्ज पर सोने के गहने कल ! • योजना की विशेषताऐं : 12 वें माह में ज़ीरो मेकिंग चार्ज का लाभ • कुल 12 माह की योजना, आसान मासिक किस्तों में अपनी पसंद के सोने के आभूषण बनवाएं • विश्वसनीय योजना, शुद्ध सोना, पूर्ण पारदर्शित • बचत, आज, सुनहरा कल • आज ही जुड़ें और ज़ीरो मेकिंग चार्ज का लाभ उठाएं • अपने सपनों के गहनों को और भी खास बनाएं! •
            </span>
            <span className="font-raleway text-sm font-semibold text-white tracking-widest px-4">
              स्वर्ण समृद्धि योजना : 10 किस्तें आपकी - 2 किस्तें हमारी • अपने सपनों के सोने के आभूषण अब आसान किस्तों में खरीदें ! • योजना की विशेषताएँ : ग्राहक केवल 10 मासिक किस्तें जमा करेगा। • अंतिम 2 किस्तों का भुगतान शेखर राजा ज्वेलर्स द्वारा किया जाएगा। • कुल 12 किस्तों के मूल्य का सोने का आभूषण खरीदने का अवसर • 100% पारदर्शी एवं विश्वसनीय योजना • आज ही जुड़ें और अपने सपनों के गहनों की शुरुआत करें! • शेखर राजा ज्वेलर्स - विश्वास शुद्धता गुणवत्ता • ज्वेलरी बुकिंग एवं अधिक जानकारी के लिए आज ही हमारे शोरूम पर संपर्क करें: +91 98765 43210 • www.shekharrjewellers.com • सोना सिर्फ आभूषण नहीं, आपके सपनों का निवेश है • जीरो मेकिंग चार्ज योजना : 10 किस्तें आपकी - ज़ीरो मेकिंग चार्ज हमारी • अपनाएं आज, बचत करें कल, पाएं ज़ीरो मेकिंग चार्ज पर सोने के गहने कल ! • योजना की विशेषताऐं : 12 वें माह में ज़ीरो मेकिंग चार्ज का लाभ • कुल 12 माह की योजना, आसान मासिक किस्तों में अपनी पसंद के सोने के आभूषण बनवाएं • विश्वसनीय योजना, शुद्ध सोना, पूर्ण पारदर्शित • बचत, आज, सुनहरा कल • आज ही जुड़ें और ज़ीरो मेकिंग चार्ज का लाभ उठाएं • अपने सपनों के गहनों को और भी खास बनाएं! •
            </span>
