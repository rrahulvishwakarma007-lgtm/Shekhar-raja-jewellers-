...
const allProducts = [
  { id: 1, name: 'Kundan Bridal Choker', category: 'Bridal', description: 'Exquisite kundan work with meenakari detailing, perfect for the modern bride.', image: '/images/necklace1.jpg', tag: 'Bestseller', featured: true },
  { id: 2, name: 'Diamond Eternity Band', category: 'Diamond', description: 'A stunning circle of brilliant diamonds symbolizing eternal love.', image: 'https://images.pexels.com/photos/2697598/pexels-photo-2697598.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Premium' },
  { id: 3, name: 'Antique Gold Jhumkas', category: 'Earrings', description: 'Traditional temple-style jhumkas with intricate peacock motifs.', image: '/images/antique1.jpg', tag: 'Heritage' },
  ...
  { id: 5, name: 'Polki Diamond Ring', category: 'Diamond', description: 'Uncut polki diamonds set in 22KT gold with a classic design.', image: 'https://images.pexels.com/photos/2697598/pexels-photo-2697598.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Exclusive', featured: true },
  { id: 6, name: 'Temple Gold Haar', category: 'Necklaces', description: 'Traditional temple necklace with goddess motifs and Lakshmi coins.', image: '/images/necklace2.jpg', tag: 'Traditional' },
  { id: 7, name: 'Ruby & Emerald Ring', category: 'Rings', description: 'Stunning cocktail ring with precious gemstones in kundan setting.', image: 'https://images.pexels.com/photos/2697598/pexels-photo-2697598.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Limited' },
  { id: 8, name: 'Antique Temple Set', category: 'Bridal', description: 'Complete antique temple set with traditional craftsmanship.', image: '/images/antique2.jpg', tag: 'Trending' },
  { id: 9, name: 'Meenakari Bridal Set', category: 'Bridal', description: 'Colorful meenakari work bridal set with traditional motifs.', image: '/images/necklace3.jpg', tag: 'Bridal Pick', featured: true },
  { id: 10, name: 'Festive Gold Set', category: 'Festive', description: 'Elegant gold set perfect for festive occasions.', image: '/images/antique3.jpg', tag: 'Festive' },
  { id: 11, name: 'Diamond Studs', category: 'Earrings', description: 'Classic diamond studs for everyday elegance.', image: 'https://images.pexels.com/photos/1191531/pexels-photo-1191531.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Everyday' },
  ...
  { id: 13, name: 'Heritage Necklace', category: 'Necklaces', description: 'Elegant heritage necklace with traditional design.', image: '/images/necklace1.jpg', tag: 'New Arrival' },
  { id: 14, name: 'Solitaire Engagement Ring', category: 'Rings', description: 'Brilliant solitaire in a classic six-prong setting.', image: 'https://images.pexels.com/photos/2697598/pexels-photo-2697598.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Premium', featured: true },
  { id: 15, name: 'Antique Choker Set', category: 'Festive', description: 'Beautiful antique choker set for festive celebrations.', image: '/images/antique1.jpg', tag: 'Traditional' },
  { id: 16, name: 'Diamond Hoop Earrings', category: 'Earrings', description: 'Contemporary diamond hoops for modern elegance.', image: 'https://images.pexels.com/photos/1191531/pexels-photo-1191531.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Trending' },
  { id: 17, name: 'Gold Band Ring', category: 'Rings', description: 'Classic gold band with elegant minimal design.', image: 'https://images.pexels.com/photos/2697598/pexels-photo-2697598.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Classic' },
  { id: 18, name: 'Diamond Cluster Ring', category: 'Diamond', description: 'Beautiful cluster of diamonds in an elegant setting.', image: 'https://images.pexels.com/photos/2697598/pexels-photo-2697598.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Luxury' },
  { id: 19, name: 'Vintage Diamond Ring', category: 'Rings', description: 'Vintage-inspired design with intricate detailing.', image: 'https://images.pexels.com/photos/2697598/pexels-photo-2697598.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Vintage' },
];
