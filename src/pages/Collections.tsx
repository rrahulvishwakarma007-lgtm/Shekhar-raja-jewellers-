...
const allProducts = [
  ...
  { id: 5, name: 'Polki Diamond Ring', category: 'Diamond', description: 'Uncut polki diamonds set in 22KT gold with a classic design.', image: '/ring6.png', tag: 'Exclusive', featured: true },
  ...
  { id: 7, name: 'Ruby & Emerald Ring', category: 'Rings', description: 'Stunning cocktail ring with precious gemstones in kundan setting.', image: '/ring7.png', tag: 'Limited' },
  { id: 8, name: 'Antique Necklace Set', category: 'Bridal', description: 'Complete antique temple set with traditional craftsmanship.', image: '/necklace22.png', tag: 'Trending' },
  { id: 9, name: 'Meenakari Bridal Set', category: 'Bridal', description: 'Colorful meenakari work bridal set with traditional motifs.', image: '/necklace3.jpg', tag: 'Bridal Pick', featured: true },
  { id: 10, name: 'Festive Gold Set', category: 'Festive', description: 'Elegant gold set perfect for festive occasions.', image: '/bangle5.png', tag: 'Festive' },
  ...
  { id: 14, name: 'Solitaire Engagement Ring', category: 'Rings', description: 'Brilliant solitaire in a classic six-prong setting.', image: '/ring6.png', tag: 'Premium', featured: true },
  { id: 15, name: 'Antique Necklace  Set', category: 'Festive', description: 'Beautiful antique choker set for festive celebrations.', image: '/necklace15.png', tag: 'Traditional' },
  ...
  { id: 17, name: 'Gold Band Ring', category: 'Rings', description: 'Classic gold band with elegant minimal design.', image: '/ring5.png', tag: 'Classic' },
  { id: 18, name: 'Diamond Cluster Ring', category: 'Diamond', description: 'Beautiful cluster of diamonds in an elegant setting.', image: '/ring3.png', tag: 'Luxury' },
  { id: 19, name: 'Vintage Diamond Ring', category: 'Rings', description: 'Vintage-inspired design with intricate detailing.', image: '/ring1.png', tag: 'Vintage' },
];
