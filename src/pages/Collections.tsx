...
const allProducts = [
  ...
  { id: 5, name: 'Polki Diamond Pendant', category: 'Diamond', description: 'Uncut polki diamonds set in 22KT gold with a classic design.', image: 'https://images.pexels.com/photos/2697598/pexels-photo-2697598.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Exclusive', featured: true },
