...
const allProducts = [
  { id: 1, name: 'Kundan Bridal Choker', category: 'Bridal', description: 'Exquisite kundan work with meenakari detailing, perfect for the modern bride.', image: 'https://images.pexels.com/photos/1413420/pexels-photo-1413420.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Bestseller', featured: true },
  { id: 2, name: 'Diamond Eternity Band', category: 'Diamond', description: 'A stunning circle of brilliant diamonds symbolizing eternal love.', image: '/uploads/rings/ring1.png', tag: 'Premium' },
  { id: 3, name: 'Antique Gold Jhumkas', category: 'Earrings', description: 'Traditional temple-style jhumkas with intricate peacock motifs.', image: 'https://images.pexels.com/photos/1191531/pexels-photo-1191531.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Heritage' },
  { id: 4, name: '22KT Gold Bangles Set', category: 'Bangles', description: 'Set of 4 intricately designed bangles with traditional patterns.', image: 'https://images.pexels.com/photos/2735970/pexels-photo-2735970.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Classic' },
  { id: 5, name: 'Polki Diamond Ring', category: 'Diamond', description: 'Uncut polki diamonds set in 22KT gold with a classic design.', image: '/uploads/rings/ring2.png', tag: 'Exclusive', featured: true },
  { id: 6, name: 'Temple Gold Haar', category: 'Necklaces', description: 'Traditional temple necklace with goddess motifs and Lakshmi coins.', image: 'https://images.pexels.com/photos/1413420/pexels-photo-1413420.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Traditional' },
  { id: 7, name: 'Ruby & Emerald Ring', category: 'Rings', description: 'Stunning cocktail ring with precious gemstones in kundan setting.', image: '/uploads/rings/ring3.png', tag: 'Limited' },
  { id: 8, name: 'Cocktail Gold Chain', category: 'Bridal', description: 'Heavy gold chain with modern link design, perfect for men.', image: 'https://images.pexels.com/photos/2735970/pexels-photo-2735970.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Trending' },
  { id: 9, name: 'Meenakari Bridal Set', category: 'Bridal', description: 'Colorful meenakari work bridal set with traditional motifs.', image: 'https://images.pexels.com/photos/1413420/pexels-photo-1413420.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Bridal Pick', featured: true },
  { id: 10, name: 'Festive Gold Set', category: 'Festive', description: 'Elegant gold set perfect for festive occasions.', image: 'https://images.pexels.com/photos/1191531/pexels-photo-1191531.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Festive' },
  { id: 11, name: 'Diamond Studs', category: 'Earrings', description: 'Classic diamond studs for everyday elegance.', image: 'https://images.pexels.com/photos/2697598/pexels-photo-2697598.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Everyday' },
  { id: 12, name: 'Gold Kada', category: 'Bangles', description: 'Heavy gold kada with traditional carvings.', image: 'https://images.pexels.com/photos/2735970/pexels-photo-2735970.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Heritage' },
  { id: 13, name: 'Pearl Drop Necklace', category: 'Necklaces', description: 'Elegant pearl drops on a delicate gold chain.', image: 'https://images.pexels.com/photos/1191531/pexels-photo-1191531.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'New Arrival' },
  { id: 14, name: 'Solitaire Engagement Ring', category: 'Rings', description: 'Brilliant solitaire in a classic six-prong setting.', image: '/uploads/rings/ring4.png', tag: 'Premium', featured: true },
  { id: 15, name: 'Antique Temple Set', category: 'Festive', description: 'Complete temple jewellery set for festive celebrations.', image: 'https://images.pexels.com/photos/1413420/pexels-photo-1413420.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Traditional' },
  { id: 16, name: 'Diamond Hoop Earrings', category: 'Earrings', description: 'Contemporary diamond hoops for modern elegance.', image: 'https://images.pexels.com/photos/2697598/pexels-photo-2697598.jpeg?auto=compress&cs=tinysrgb&w=600', tag: 'Trending' },
  { id: 17, name: 'Gold Band Ring', category: 'Rings', description: 'Classic gold band with elegant minimal design.', image: '/uploads/rings/ring5.png', tag: 'Classic' },
  { id: 18, name: 'Diamond Cluster Ring', category: 'Diamond', description: 'Beautiful cluster of diamonds in an elegant setting.', image: '/uploads/rings/ring6.png', tag: 'Luxury' },
  { id: 19, name: 'Vintage Diamond Ring', category: 'Rings', description: 'Vintage-inspired design with intricate detailing.', image: '/uploads/rings/ring7.png', tag: 'Vintage' },
];
