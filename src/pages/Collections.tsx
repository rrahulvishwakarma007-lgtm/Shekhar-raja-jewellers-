...
const allProducts = [
  ...
  { id: 4, name: '22KT Gold Bangles Set', category: 'Bangles', description: 'Set of 4 intricately designed bangles with traditional patterns.', image: '/bangle1.png', tag: 'Classic' },
  ...
  { id: 8, name: 'Cocktail Gold Chain', category: 'Bridal', description: 'Heavy gold chain with modern link design, perfect for men.', image: '/bangle2.png', tag: 'Trending' },
  ...
  { id: 12, name: 'Gold Kada', category: 'Bangles', description: 'Heavy gold kada with traditional carvings.', image: '/bangle3.png', tag: 'Heritage' },
