  ...
  const handleFormSubmit = async () => {
    ...
    try {
      ...
      await fetch(WEBHOOK_URL, {
        ...
        body: JSON.stringify({
          date:       readableDate,          // A — Date
          fullName:   name.trim(),           // B — Full Name
          phone:      phone.trim(),          // C — Phone Number
          city:       address.trim(),        // D — City
          emi:        emiAmount,             // E — EMI Chosen
          userPays:   userPays,              // F — Amount User Pays
          srjBonus:   srjBonus,             // G — Amount SRJ Pays (Bonus)
          totalValue: totalValue,            // H — Total Jewelry Value
        }),
      });
